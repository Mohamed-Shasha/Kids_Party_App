 ...
 */
final class Version20220504113735 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cake_delivery (id INT AUTO_INCREMENT NOT NULL, cadeorder_id INT DEFAULT NULL, user_id INT DEFAULT NULL, address VARCHAR(255) NOT NULL, date DATETIME NOT NULL, time TIME NOT NULL, UNIQUE INDEX UNIQ_B4C9B3E39306E3DF (cadeorder_id), INDEX IDX_B4C9B3E3A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
